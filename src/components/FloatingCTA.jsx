    ...
    <div className="fixed left-6 bottom-6 z-40 flex items-center gap-3">
      ...
      >
        <span className="w-9 h-9 rounded-full bg-[var(--blue)] group-hover:bg-white grid place-items-center transition-colors">
          <Calendar size={16} className="text-white group-hover:text-[var(--blue)] transition-colors" />
        </span>
        <span className="flex flex-col items-start">
          <span className="mono text-[9px] tracking-widest text-white/60 group-hover:text-white/80">AVAILABLE Q3</span>
